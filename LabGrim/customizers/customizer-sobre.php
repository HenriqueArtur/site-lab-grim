<?php
	...
	function labgrim_sobre_customizer( $wp_customize ) {
		...
		////////////////////CUSTOMIZER O QUE É////////////////////////////////
			...
			$wp_customize->add_section(
				...
				'sec_oqe', array(
					// texto
					'title' 				=> 'Texto descritivo do projeto',
				)
			);
			...
			$wp_customize->add_control(
				...
				'set_oqe-texto', array(
					...
					'label' 				=> 'Texto descritivo do projeto',
		...
		////////////////////CUSTOMIZER COMO COMEÇOU////////////////////////////////

			// Esse obj recebe a funcao que cria o secao no painel do WP
			$wp_customize->add_section(
				// aqui voce coloca o slug(ID) da secao recomendo colocar "sec_" ao inicio da slug
				'sec_como-comecou', array(
					// texto
					'title' 				=> 'Texto de como começou',
				)
			);
			...
			$wp_customize->add_control(
				...
				'set_como-comecou-texto', array(
					// Titulo que vai encima da caixa de texto
					'label' 				=> 'Texto de como começou',
					// Aqui deve coloca a SLUG de SECAO no caso sec_pesquisador_senior_2
					'section'				=> 'sec_como-comecou',
					// aqui é o tipo de area vai aparece no painel WP, no caso é um textarea
					'type'					=> 'textarea'
				)
			);
	...
	add_action( 'customize_register', 'labgrim_sobre_customizer' );
